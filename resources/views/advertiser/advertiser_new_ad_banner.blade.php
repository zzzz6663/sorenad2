            ...
            {{--  <div class="dashboard_site_form">
                ...
                <div class="flex_tworow appads_upload_icon">
                    ...
                    <p>
                        ...
                        <span>
                            ابعاد بنر 728 در 130 پیکسل باشد.
                        </span>
                    </p>
                    <p>
                        <label for="banner2">آپلود بنر برنامه</label>
                        <input type="file" id="banner2" name="banner2" accept="image/png, image/jpeg">
                        <span>
                            ابعاد بنر 275 در 180 پیکسل باشد.
