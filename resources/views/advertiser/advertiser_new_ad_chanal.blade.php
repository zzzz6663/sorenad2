...
@section('content')
<h2 class="title_right">سفارش تبلیغ کانال</h2>

@include("master.error")
<div class="card">
    <div class="card-inner">
        <form action="{{ route("advertiser.new.ad.chanal") }}" method="post" enctype="multipart/form-data" id="wizard-01" class="nk-wizard nk-wizard-simple is-alter">
            @csrf
            @method('post')
