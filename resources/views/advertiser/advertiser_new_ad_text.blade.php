...
@section('content')
<h2 class="title_right">سفارش تبلیغ متنی</h2>
<div class="card">
    <div class="card-inner">
        @include("master.error")
        <form action="{{ route("advertiser.new.ad.text") }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('post')
...
{{--
            <div class="dashboard_site_form">
                ...
                <div class="flex_tworow">
                    <p>
                        <label for="text">متن تبلیغ </label>
                        <input type="text" id="text" name="text" value="{{ old("text") }}">
                        <span>حداکثر 9 کلمه</span>
                    </p>
                </div>
