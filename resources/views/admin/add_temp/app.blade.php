    ...
    <div class="soren_ad_container">
        ...
        <div class="sorenad_body">
            ...
            <div class=" sorenad_btn_par">
                ...
                <a target="blank" class="sorenad_btn" href="{{Illuminate\Support\Facades\URL::signedRoute('redirect.add', ["site_id"=>$site->id,"ip"=>$ip,'advertis_id' =>  $advertise->id,"link_number"=>2]) }}">
                    {{ $advertise->landing_title2 }}
                </a>
                @endif
                @if($advertise->landing_link3)
                <a  target="blank" class="sorenad_btn" href="{{Illuminate\Support\Facades\URL::signedRoute('redirect.add', ["site_id"=>$site->id,"ip"=>$ip,'advertis_id' =>  $advertise->id,"link_number"=>3]) }}">
