...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">لیست دسته بندی کانال ها</h3>
            <div class="nk-block-des text-soft">
                <p>شما در مجموع

                    {{ $groups->total() }}
                    دسته بندی کانال ها دارید.</p>
            </div>
        </div>
            ...
            <div class="toggle-wrap nk-block-tools-toggle">
                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                    <ul class="nk-block-tools g-3">
                        <li>
                            <a href="{{ route("group.create") }}" class="btn btn-white btn-outline-light"><span>دسته بندی کانال ها جدید</span></a>
                        </li>
...
<div class="nk-block">
    <div class="card card-stretch">
        <div class="card-inner-group">
            ...
            <form action="{{ route('group.index') }}" method="get" autocomplete="off">
                @csrf
                @method('get')
                        ...
                        <div class="card-tools">
                            <div class="form-inline flex-nowrap gx-3">
                                ...
                                <div class="form-wrap w-150px">
                                    ...
                                    <a href="{{ route("user.group") }}" class="btn btn-danger"><i class="fas fa-window-close"></i></a>
                                    @endif
                                </div>
                            </div>
                            <!-- .form-inline -->
                ...
                <div class="card-inner p-0">
                    <div class="nk-tb-list nk-tb-ulist is-compact">
                        ...
                        <div class="nk-tb-item">
                            ...
                            <div class="nk-tb-col ">
                                <span data-bs-toggle="tooltip" data-bs-placement="top" aria-label="ارسال ایمیل" class="text  text-{{ $group->active?"success":"danger" }} " title="{{ $group->active?"active":"معمولی" }}">
                                    <i class="fas fa-thumbs-{{ $group->active?"up":"down" }} ">
                                    </i>
                                </span>
                            </div>
                            <div class="nk-tb-col ">
                                <span>
                                    {{ jdate($group->created_at)->format("Y-m-d") }}
                                </span>
                            </div>
                                        ...
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <ul class="link-list-opt no-bdr">
                                                    <li>
                                                        <a href="{{ route("group.edit",$group->id) }}" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="ویرایش  ">
                ...
                <div class="card-inner">
                    {{ $groups->appends(Request::all())->links('admin.section.pagination') }}
                </div>
            {{--  <div class="card-inner">
