...
return [
    ...
    */
    ...
    'same'                 => ':attribute و :other باید یکسان هم باشند.',
    'size'                 => [
    ...
    */
    ...
    'attributes' => [
        ...
        'active'                  => 'وضعیت',
        'debt_id'                  => '    طرف بدهکار ',
        'demand_id'                  => '    طرف طلبکار ',
        'debt_price'                  => '    مبلغ بدهکار ',
        'demand_price'                  => '    مبلغ طلبکار ',
        'submited'                  => '   تاریخ  ',
        ...
        'shaba'                  => ' شماره شبا',
        'cart'                  => ' شماره کارت ',
        'account'                  => ' نام صاحب حساب',
        'a_mellicode'                  => 'کد ملی صاحب حساب ',
        'bank'                  => ' بانک',
        'site'                  => ' سایت ',
        'order_count'                  => ' تعداد سفارش',
        'landing_title1' => ' عنوان صفحه فرود',
        'landing_title2' => ' عنوان صفحه فرود',
        'landing_title3' => ' عنوان صفحه فرود',
        'landing_link1' => ' لینک صفحه فرود',
        'landing_link2' => ' لینک صفحه فرود',
        'landing_link3' => ' لینک صفحه فرود',
        'limit_daily_view' => 'نمایش  در روز ',
        'device' => 'دستگاه تبلیغ  ',
        'pay_type' => ' روش پرداخت',
        'banner1' => ' فایل بنر برنامه',
        'banner2' => ' فایل بنر برنامه',
        ...
        'click' => 'کلیک ',
        'call_to_action' => ' پیام اقدام به دعوت',
        'video1' => ' ویدیو  ',
        ...
        'attach' => 'فایل پیویست تبلیغ  ',
        'socials' => 'شبکه ه های اجتماعی ',
        '' => ' ',
        '' => ' ',
        '' => ' ',
        '' => ' ',
