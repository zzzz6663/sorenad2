  ...
  NioApp.Calendar = function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      events: [{
        ...
        title: 'حواس خواننده پرت خواهد شد',
        start: YM + '-03T13:30:00',
        className: "fc-event-danger",
        description: "از قسمتی از لورم ایپسوم استفاده کنید، باید مطمئن شوید که هیچ چیز شرم آوری پنهان نیست."
      }, {
        id: 'default-event-id-' + Math.floor(Math.random() * 9999999),
        ...
        id: 'default-event-id-' + Math.floor(Math.random() * 9999999),
        title: 'لورم ایپسوم متن - انتشار محصول',
        start: YM + '-02',
        end: YM + '-04',
        className: "fc-event-primary",
        description: "از قسمتی از لورم ایپسوم استفاده کنید، باید مطمئن شوید که هیچ چیز شرم آوری پنهان نیست."
        ...
        id: 'default-event-id-' + Math.floor(Math.random() * 9999999),
        title: 'قطعه ای از ادبیات کلاسیک لاتین',
        start: TODAY,
        end: TODAY + '-01',
        className: "fc-event-primary",
        description: "از قسمتی از لورم ایپسوم استفاده کنید، باید مطمئن شوید که هیچ چیز شرم آوری پنهان نیست."
